...
public class Ciphers{
    ...
    public static void Main(){
        ...
        Console.WriteLine("1. A1Z26 Encode");
    ...
    public static void EncodeAll(string text){
        Console.WriteLine("A1Z26: " + A1Z26_Encode(text));
        Console.WriteLine("ATBASH: " + Atbash(text));
        Console.WriteLine("BINARY: " + Binary_Encode(text));
        Console.WriteLine("BRAILLE: " + Braille_Encode(text));
        Console.WriteLine("CAESAR (shift 3): " + Caesar_Encode(text, 3));
        Console.WriteLine("COLUMNAR (key reverses): " + Columnar_Encode(text, "EDCBA"));
        Console.WriteLine("MORSE: " + Morse_Encode(text));
        Console.WriteLine("PHONE: " + Phone_Encode(text));
    }
